...
------------------------------
**#TMUX**
tmux new -s work -n work \; split-window -d -t 0 -v -l "30%" weechat \; split-window -h -l "47%" htop \; split-window -v -l "68%" vlc -I ncurses --no-video https://www.youtube.com/watch?v=jfKfPfyJRdk \; split-window -v -p75
tmux new -s work -n work \; split-window -d -t 0 -v -l "30%" weechat \; split-window -h -l "47%" htop \; split-window -v -l "65%"
------------------------------
**#SSH**
